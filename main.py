...
IMG_SHIP = "https://images.unsplash.com/photo-1566024287285-457247b70310?w=1200&q=80"

# ============================================================
# 二、R2 图片地址（替换原本地文件）
# ============================================================
BG_URL  = f"{R2_BASE}/background.png"   # 页面背景
MAO_IMG = f"{R2_BASE}/mao.jpg"          # 毛淼华照片
MAP_IMG = f"{R2_BASE}/map.jpg"          # 联系我们的地图
PAGE_ICON = f"{R2_BASE}/logo.png"       # 网页图标
...
def page_team():
    ...
    members = [
        ...
        ("董伟", "硕士研究生", "（待补充）"),
        ("乐昆", "硕士研究生", "（待补充）"),
        ("Mannan Aleem", "硕士研究生", "（待补充）"),
        ("邱赫", "硕士研究生", "风暴潮与淹没范围预报"),
    ]
    for i in range(0, len(members), 3):
        cells = [
            text_card(f"<b>{role}</b><br>研究方向：{field}", f"👤 {name}")

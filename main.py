...
TEAM_PHOTOS = [
    ...
    f"{R2_BASE}/team/group10.jpg?v={TEAM_PHOTO_VERSION}",
]
...
MAO_BIO_HTML_ZH = (
    ...
    "并获中国科学院网站科研进展栏目官方报道，2022年、2024年、2025年各报道1次，2026年连续报道2次，"
...
MAO_BIO_HTML_EN = (
    ...
    "highlights of the Chinese Academy of Sciences (2022, 2024, 2025, and twice in 2026). He has delivered more than "
    "20 oral and poster presentations at international conferences including AGU and ECSA.</p>"
...
MEMBERS_ZH = [
    ...
    ("Mannan Aleem", "CAS-ANSO Scholarship<br>硕士研究生", "Remote sensing and data analysis",
...
# ============================================================
ALUMNI_MASTER = [
    ("QuAN",   '<span class="tag">全奖</span>赴英国 University of Nottingham 攻读 Ph.D.'),
    ("高盛涵", '<span class="tag">全奖</span>赴美国 College of William &amp; Mary 攻读 Ph.D.'),
    ("牟丽颖", "济南浪潮集团"),
]
ALUMNI_MASTER_EN = [
    ("QuAN",       '<span class="tag">Full Scholarship</span>Ph.D. at University of Nottingham, UK'),
...
@media (max-width: 900px) {{
    ...
    .alumni-name  {{ flex: 0 0 74px !important; font-size: 14.5px !important; padding-left: 12px !important; }}
...
@media (max-width: 480px) {{
    ...
    .alumni-name {{ flex: 0 0 66px !important; font-size: 13.5px !important; }}

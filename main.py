...
# ============================================================
SERVICES_ZH = [
    {"title": "《武汉科技大学学报》第二届青年编委",
     "url": "https://xbbjb.wust.edu.cn/info/1261/2471.htm"},
    {"title": "《长沙理工大学学报（自然科学版）》第二届青年编委",
     "url": "https://cslgxbzk.csust.edu.cn/cslgdxxbzk/site/menus/20251110163825001"},
    {"title": "MDPI Oceans 期刊首届青年编委",
     "url": "https://mdpi.cn/announcements/2267"},
    {"title": "MDPI 2024 杰出审稿人论坛受邀报告",
     "url": "https://mdpi.cn/announcements/1403"},
    {"title": "MDPI 2023 杰出审稿人奖（JMSE）",
     "url": "https://mdpi.cn/announcements/1329"},
    {"title": "Geosciences 专刊 “Machine Learning in Engineering Geology”",
     "url": "https://www.mdpi.com/journal/geosciences/special_issues/MLN0IH1434"},
    {"title": "Oceans 专刊 “Recent Progress in Ocean Fronts”",
     "url": "https://www.mdpi.com/journal/oceans/special_issues/LLO351HQ8K"},
    {"title": "Water 专刊 “Coastal Engineering and Fluid–Structure Interactions”",
     "url": "https://www.mdpi.com/journal/water/special_issues/U9P32Z0A55"},
    {"title": "Water 专刊 “Hydrodynamic Modeling and Observational Techniques in Coastal and Estuarine Regions”",
     "url": "https://www.mdpi.com/journal/water/special_issues/3S20HB07TX"},
    {"title": "Geosciences GEClub-9 环境主题在线研讨会",
     "url": "https://sciforum.net/event/GEClub-9-environment"},
    {"title": "上海海洋大学与中国科学院烟台海岸带研究所科教融合战略合作签约",
     "url": "https://sthj.shou.edu.cn/_t1344/2023/0912/c16731a321323/page.htm"},
]

SERVICES_EN = [
    {"title": "2nd Youth Editorial Board, Journal of Wuhan University of Science and Technology",
     "url": "https://xbbjb.wust.edu.cn/info/1261/2471.htm"},
    {"title": "2nd Youth Editorial Board, Journal of Changsha University of Science & Technology (Natural Science)",
     "url": "https://cslgxbzk.csust.edu.cn/cslgdxxbzk/site/menus/20251110163825001"},
    {"title": "Founding Youth Editorial Board, MDPI Oceans",
     "url": "https://mdpi.cn/announcements/2267"},
    {"title": "Invited Talk at MDPI 2024 Outstanding Reviewer Forum",
     "url": "https://mdpi.cn/announcements/1403"},
    {"title": "MDPI 2023 Outstanding Reviewer Award (JMSE)",
     "url": "https://mdpi.cn/announcements/1329"},
    {"title": "Geosciences Special Issue “Machine Learning in Engineering Geology”",
     "url": "https://www.mdpi.com/journal/geosciences/special_issues/MLN0IH1434"},
    {"title": "Oceans Special Issue “Recent Progress in Ocean Fronts”",
     "url": "https://www.mdpi.com/journal/oceans/special_issues/LLO351HQ8K"},
    {"title": "Water Special Issue “Coastal Engineering and Fluid–Structure Interactions”",
     "url": "https://www.mdpi.com/journal/water/special_issues/U9P32Z0A55"},
    {"title": "Water Special Issue “Hydrodynamic Modeling and Observational Techniques in Coastal and Estuarine Regions”",
     "url": "https://www.mdpi.com/journal/water/special_issues/3S20HB07TX"},
    {"title": "Geosciences GEClub-9 Online Seminar on Environment",
     "url": "https://sciforum.net/event/GEClub-9-environment"},
    {"title": "Strategic Cooperation Agreement on Sci-Tech Integration between Shanghai Ocean University and YIC-CAS",
     "url": "https://sthj.shou.edu.cn/_t1344/2023/0912/c16731a321323/page.htm"},
]
...
@media (max-width: 900px) {{
    ...
    .sub-title {{ font-size: 19px !important; margin: 22px 0 6px !important; padding-left: 11px !important; border-left-width: 4px !important; }}
    ...
    .service-card {{ padding: 14px 40px 14px 16px !important; min-height: 54px !important; }}
    .service-card-title {{ font-size: 14.5px !important; }}
    .service-card::after {{ right: 16px !important; font-size: 13px !important; }}
...
@media (max-width: 480px) {{
    ...
    .service-card-title {{ font-size: 13.5px !important; }}
}}
</style>
"""
...
def services_list_html(services) -> str:
    """渲染学术服务列表，仅显示标题，双列布局，文字垂直居中。"""
    cards = ""
    for s in services:
        url = (s.get("url") or "").strip()
        title = s.get("title", "")
        inner = f'<div class="service-card-title">{title}</div>'
        if url:
            cards += f'<a class="service-card" href="{url}" target="_blank" rel="noopener">{inner}</a>'
        else:
            cards += f'<div class="service-card">{inner}</div>'
...
def page_news():
    ...
    services_data = SERVICES_EN if st.session_state.lang == "en" else SERVICES_ZH
    ...
    # ---------- 学术服务 ----------
    show(f'<div class="sub-title">{t("学术服务", "Academic Services")}</div>')
    show(
        f'<div class="sub-desc">'
        f'{t("课题组成员在学术期刊编委、审稿人、专刊组织及学术合作等方面的服务情况。", "Editorial board memberships, reviewer roles, special issue organization and academic cooperation by group members.")}'
        f'</div>'
    )
    st.markdown(services_list_html(services_data), unsafe_allow_html=True)

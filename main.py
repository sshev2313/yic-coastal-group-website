...
def image_carousel(slides):
    """
    轮播组件：容器按 3:2 比例显示，宽度限制在 900px 以内并居中。
    iframe 高度固定为 620px（对应 900×600 的 3:2 容器 + 边距）。
    """
    slides_html = ""
    dots_html = ""
    ...
    * {{ margin: 0; padding: 0; box-sizing: border-box; }}
    ...
    """
    # iframe 高度：900px 宽 × 2/3 = 600px + 边距
...
def page_team():
    ...
    # ★ 毛老师照片也用 3:2 比例（object-position: top center 保证脸部可见）
    grid_row([
